    ...
    <AnimatePresence>
      {selectedCount > 0 && (
        <motion.div
          ...
          className="fixed right-6 bottom-20 z-50 bg-surface-card backdrop-blur-xl border border-borders-primary rounded-card shadow-card p-4 w-64"
        >
          <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-2">
              ...
              <Button onClick={handleDelete} variant="secondary" className="bg-status-danger-bg/50 hover:bg-status-danger-bg/80 text-status-danger-text">
                <Trash2 size={16} />
                <span>Delete</span>
              </Button>
            </div>
